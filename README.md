...
Build workflows for the **00000vpn** Flutter VPN app. Same pipeline as BuddhaJump's,
...
Checkout:
- `PRIVATE_REPO` — `BuddhaJumpApp/00000vpn`
...
- `APPLE_PROVISIONING_BASE64` — provisioning profiles for `com.fjolsky.00000vpn` and `com.fjolsky.00000vpn.service`
